            ...
            <div className="space-y-3 text-sm text-[#52525b] border-t border-black/8 pt-5">
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="w-9 h-9 rounded-xl bg-black/5 border border-black/10 flex items-center justify-center text-[#09090b] shrink-0">
                    <WhatsAppIcon className="w-4 h-4" />
                  </span>
                  <div>
                    <p className="text-[10px] text-[#71717a] uppercase font-semibold">Instant Studio Chat</p>
                    <p className="text-[#09090b] font-semibold text-xs group-hover:text-black transition-colors">WhatsApp Direct Desk</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="w-9 h-9 rounded-xl bg-black/5 border border-black/8 flex items-center justify-center text-[#09090b] shrink-0">
                    <InstagramIcon className="w-4 h-4" />
                  </span>
                  <div>
                    <p className="text-[10px] text-[#71717a] uppercase font-semibold">Reels & Showreel</p>
                    <p className="text-[#09090b] font-semibold text-xs group-hover:text-black transition-colors">@motionlabs.studio</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#09090b] font-semibold text-xs group-hover:text-black transition-colors">Motion Labs Agency</p>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3.5 pt-2">
                <span className="w-9 h-9 rounded-xl bg-black/5 border border-black/8 flex items-center justify-center text-[#09090b] font-bold text-xs shrink-0">
                  ✉
                </span>
                <div>
                  <p className="text-[10px] text-[#71717a] uppercase font-semibold">Direct Email</p>
                  <a href="mailto:hello@motionlabs.in" className="text-[#09090b] font-semibold text-xs hover:text-black transition-colors">
                    hello@motionlabs.in
                  </a>
                </div>
              </div>
