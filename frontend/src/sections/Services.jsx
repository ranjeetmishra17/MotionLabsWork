...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 md:py-32 bg-[#fafafb] border-t border-black/8 relative">
            ...
            return (
              <div
                ...
                className={`liquid-card transition-all duration-300 overflow-hidden ${
                  isOpen
                    ? 'border-black/50 shadow-2xl ring-1 ring-black/15'
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5 sm:gap-8">
                    <span className="text-base sm:text-lg text-[#09090b] font-mono font-bold">
                      {s.n}
                    </span>
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    <span className="hidden sm:inline-block text-xs font-semibold px-3 py-1 rounded-full bg-black/5 text-[#09090b] border border-black/15">
                      {s.metric}
                    </span>
                    <span
                      className={`w-8 h-8 rounded-full border flex items-center justify-center text-sm font-bold transition-all ${
                        isOpen
                          ...
                          : 'border-black/20 text-[#09090b] bg-black/5 hover:border-black/50'
                      }`}
                    >
                      {isOpen ? '−' : '+'}
                    </span>
                      ...
                      <div className="px-6 pb-8 sm:px-8 sm:pb-8 pt-0 grid md:grid-cols-[1.2fr_0.8fr] gap-6 items-end border-t border-black/8 mt-2 pt-6">
                        ...
                        <div className="flex flex-wrap gap-2 md:justify-end">
                          {s.tags.map((t) => (
                            <span
                              key={t}
                              className="text-xs font-medium px-3 py-1 rounded-full liquid-glass-pill text-[#09090b]"
                            >
                              {t}
                            </span>
                          ))}
